export { getResponsive } from '../../modules/responsive.js?v=8.0.6'
import { copy, drag, getDescribedElement, getOuterHeight, getWidth } from '../../modules/utility.js?v=8.0.6'
import '../../modules/browser.js?v=8.0.6'
